...
function l(e) {
    ...
    return o && 'BODY' !== o && 'HTML' !== o
        ? -1 !== ['TD', 'TABLE'].indexOf(t.nodeName) && 'static' === s(t, 'position')
            ? l(t)
            : t
        : e
...
function E(e, t, o, n) {
    return Math.max(
        ...
        o[`offset${e}`],
        o[`scroll${e}`],
        y() ? o[`offset${e}`] + n[`margin${'Height' === e ? 'Top' : 'Left'}`] + n[`margin${'Height' === e ? 'Bottom' : 'Right'}`] : 0
    );
}
function v() {
...
function N(e, t, o, n) {
    ...
    if ('viewport' === n) i = T(r);
        ...
        let o;
        'scrollParent' === n
            ? ((o = f(a(t))), 'BODY' === o.nodeName && (o = e.ownerDocument.documentElement))
            : 'window' === n
...
function X(e, t) {
    Object.keys(t).forEach((o) => {
        let n = '';
        -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && _(t[o]) && (n = 'px'), (e.style[o] = t[o] + n);
    });
}
function J(e, t) {
...
function Q(e, t) {
    ...
    const d = void 0 === p ? t.gpuAcceleration : p,
        ...
        u = Y('transform');
    let g, b;
    if (((b = 'bottom' == h ? -a.height + m.bottom : m.top), (g = 'right' == c ? -a.width + m.right : m.left), d && u))
        (f[u] = `translate3d(${g}px, ${b}px, 0)`), (f[h] = 0), (f[c] = 0), (f.willChange = 'transform');
    else {
    ...
    return (
        (e.attributes = O({}, w, e.attributes)), (e.styles = O({}, f, e.styles)), (e.arrowStyles = O({}, e.offsets.arrow, e.arrowStyles)), e
    );
}
function ee(e, t, o) {
...
function te(e, t) {
    ...
    return (w = Math.max(Math.min(i[d] - h, w), 0)), (e.arrowElement = o), (e.offsets.arrow = { [f]: Math.round(w), [l]: '' }), e;
}
function oe(e) {
    ...
    return (
        p.forEach((d, s) => {
            ...
            const a = e.offsets.popper,
                ...
                y =
                    !!t.flipVariations &&
                    ((w && 'start' === r && h) || (w && 'end' === r && c) || (!w && 'start' === r && u) || (!w && 'end' === r && g));
            (m || b || y) &&
                ((e.flipped = !0),
                (m || b) && (n = p[s + 1]),
                y && (r = oe(r)),
                (e.placement = n + (r ? '-' + r : '')),
                (e.offsets.popper = O({}, e.offsets.popper, k(e.instance.popper, e.offsets.reference, e.placement))),
...
function me(e, t) {
    ...
    const p = {
        primary(e) {
            let o = r[e];
            return r[e] < n[e] && !t.escapeWithReference && (o = Math.max(r[e], n[e])), { [e]: o };
        },
        secondary(e) {
            const o = 'right' === e ? 'left' : 'top';
            let i = r[o];
            return r[e] > n[e] && !t.escapeWithReference && (i = Math.min(r[o], n[e] - ('right' === e ? r.width : r.height))), { [o]: i };
        },
    };
    return (
        i.forEach((e) => {
...
var ge = {
        ...
        flip: { order: 600, enabled: !0, fn: de, behavior: 'flip', padding: 5, boundariesElement: 'viewport' },
