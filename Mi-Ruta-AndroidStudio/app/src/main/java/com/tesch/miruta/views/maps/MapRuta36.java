...
public class MapRuta36 extends AppCompatActivity {
    ...
    ImageButton buttonBack, likeRuta1;
    CardView ruta1, ruta2, ruta3, ruta4, ruta5;
    SearchView searchRoute36;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_ruta36);
        views();
        setupSearch();
    }
    ...
    private void setupSearch() {
        searchRoute36.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
    ...
    private void cardEvent(){
        ruta1.setOnClickListener(new View.OnClickListener() { //Chalco la loma
            @Override
        ...
        likeRuta1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                campo_id_ruta = "ruta1";
                nombre = "Ruta 36: Chalco - Loma";
                origen = "Chalco";
                destino = "La loma";
    ...
    private void views() {
        ...
        likeRuta1 = findViewById(R.id.likeRuta1);
        searchRoute36 = findViewById(R.id.searchRoute36);
    ...
    private void menuDrawerOptions() {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(MapRuta36.this, MainActivity.class);
            }
        });
        ...
        chatbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(MapRuta36.this, ChatbotActivity.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(MapRuta36.this, AboutActivity.class);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(MapRuta36.this, Profile.class);
            }
        });
        ...
        fav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(MapRuta36.this, Favorite.class);
            }
        });
        ...
        call.enqueue(new Callback<LoginResult>() {
            ...
            public void onResponse(Call<LoginResult> call, Response<LoginResult> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(MapRuta36.this, "Error en la respuesta: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<LoginResult> call, Throwable t) {
                ...
                Toast.makeText(MapRuta36.this, "Error en la solicitud: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void showDialog() {
        dialog = new Dialog(MapRuta36.this);
        ...
        btnDialogLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MapRuta36.this, Login.class);
